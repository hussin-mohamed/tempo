...
#
# Script generated by Vivado on Tue Jul 22 16:58:17 CEST 2025
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hhussien/fpga_assignment/assignment_1/counter/counter.cache/compile_simlib/modelsim"
  fi
